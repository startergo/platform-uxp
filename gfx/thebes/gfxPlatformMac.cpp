...
gfxPlatformMac::IsFontFormatSupported(nsIURI *aFontURI, uint32_t aFormatFlags)
{
    ...
    // The former TenFourFox URL blacklist is no longer needed. On pre-10.6,
    // downloaded fonts receive a new, internally consistent CFF/ATS identity
    // and are validated before the private ATS font is exposed to Gecko.
