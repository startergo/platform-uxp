                                      ...
                                      uint32_t aSourceLength)
{
  ...
  if (aSourceLength >= alignLen && aSourceLength - alignLen > 31) {
    ...
    if (maxIndex <= aSourceLength && i < maxIndex) {
      ...
      const vector unsigned short lowByteMask =
      ...
      if ((NS_PTR_TO_UINT32(aOurSource) & 15) == 0) {
        ...
        while (1) {
          ...
          packed1 = vec_packsu(vec_and(source1, lowByteMask),
                               vec_and(source2, lowByteMask));
          packed2 = vec_packsu(vec_and(source3, lowByteMask),
                               vec_and(source4, lowByteMask));
